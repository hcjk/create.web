...
coroutine.wrap(function()
    local res = fetch({
        url = "http://third-fw.gl.at.ply.gg:16881/tlds",
        method = "GET",
...
function fetch_dns()
    ...
    print(body)
    local res = fetch({
        url = "http://third-fw.gl.at.ply.gg:16881/domain",
        method = "POST",
        headers = { ["Content-Type"] = "application/json" },
        body = body,
    })
...
publish_done.on_click(function()
    ...
    if res["secret_key"] then
        result.set_content("Congrats! Your key: " .. res["secret_key"] .. "\nPLEASE SAVE IT. OTHERWISE YOU WILL LOOSE PERMISSIONS TO UPDATE OR DEL")
    else
...
update_done.on_click(function()
    ...
    local res = fetch({
        url = "http://third-fw.gl.at.ply.gg:16881/domain/" .. update_key.get_content(),
        method = "PUT",
        headers = { ["Content-Type"] = "application/json" },
        body = body,
    })
...
delete_done.on_click(function()
    local res = fetch({
        url = "http://third-fw.gl.at.ply.gg:16881/domain/" .. delete_key.get_content(),
        method = "DELETE",
        headers = { ["Content-Type"] = "application/json" },
    })
